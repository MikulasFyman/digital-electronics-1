...
2. Calculate how many periods of clock signal with frequency of 100&nbsp;MHz contain time intervals 2&nbsp;ms, 4&nbsp;ms, 10&nbsp;ms, 250&nbsp;ms, 500&nbsp;ms, and 1&nbsp;s. Write values in decimal, binary, and hexadecimal forms.
  ...
  <img width="393" alt="image" src="https://user-images.githubusercontent.com/99393884/158791112-cb579947-1eb6-45f4-b003-f749189b2bd2.png">
   ...
   | 4&nbsp;ms | 400 000 | | `b"0011_0000_1101_0100_0000"` |
   | 10&nbsp;ms | 1 000 000 | | `b"0110_0001_1010_1000_0000"` |
   | 250&nbsp;ms | 25 000 000 | | `b"1111_0100_0010_0100_0000"` |
   | 500&nbsp;ms | 50 000 000 | | `b"0001_0111_1101_0111_1000_0100_0000"` |
